    ...
    >
      <div className="form-container bg-dark mt-3">
        <div class="contact px-5 pt-4 pb-5 w-100">
          <div class="col ">
            {" "}
            <p>Upload {selectedPlaylist.name} to your spotify account.</p>{" "}
          </div>
          ...
          <div class="col mt-1">
            <input
              type="text"
              class="form-control  bg-dark"
              placeholder="Spotify Auth Token"
          ...
          <div class="col d-flex justify-content-center">
            {" "}
            <button
              class="btn btn-success mt-4 px-5 w-100"
              onClick={handleCreatePlaylist}
            >
              Create Playlist<i class="fa fa-long-arrow-right ml-2 mt-1"></i>
            </button>{" "}
          </div>
        </div>
      </div>
