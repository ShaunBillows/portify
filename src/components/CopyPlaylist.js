...
const CopyPlaylist = ({ tracks, cookies, setUser, closeModal, modalContent, playlists, setEditPlaylist, setPage }) => {
    ...
    <label  className="" style={{maxWidth:"270px"}}>Copy selected tracks into a new playlist.<br></br></label>
